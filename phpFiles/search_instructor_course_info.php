...
$sql1 = "SELECT DISTINCT course.code, course.title, course.semester, section.enrollment, info.building FROM course, assign, has, info, section WHERE assign.instr_name = '$name' AND assign.crn = has.crn AND has.code = course.code AND has.crn = section.crn AND assign.info_id = info.id";
